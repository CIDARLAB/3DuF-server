...
class Component:
    def __init__(self, obj, entity, position, params):
        ...
        obj.addProperty("App::PropertyString", "Type", entity, "Type of component").__entity = entity

        obj.Proxy = self
        obj.Label = "3DuF_Object"
    
    def execute(self, fp):
        myDocument = FreeCAD.open(u"/home/ubuntu/3DuF-server/partpipeline/threedprinting/components/sources/" + fp.__entity + u".FCStd")
