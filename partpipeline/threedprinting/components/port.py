...
class Port:
    def __init__(self, obj, position=[0, 0, 0], radius=0.005, height=0.010):
        ...
        obj.addProperty(
            "App::PropertyLength", "Radius", "Port", "Radius of the port"
        ).Radius = radius
        obj.addProperty(
            "App::PropertyLength", "Height", "Port", "Height of the port"
        ).Height = height
        obj.addProperty(
            "App::PropertyPosition", "Position", "Port", "Position of the port"
        ).Position = pnt
        obj.addProperty(
            "App::PropertyDirection", "Direction", "Port", "Direction of the port"
        ).Direction = direction
        obj.Proxy = self
