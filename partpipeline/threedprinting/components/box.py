...
class Box:
    def __init__(self, obj, position=[0,0,0], width=10.0, height=10.0, length=10.0):
        ...
        obj.addProperty("App::PropertyLength","Width","Box","Width of the box").Width=width
        obj.addProperty("App::PropertyLength","Height","Box", "Height of the box").Height=height
